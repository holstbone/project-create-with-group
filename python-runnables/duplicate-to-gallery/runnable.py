...
class MyRunnable(Runnable):
    ...
    def run(self, progress_callback):
        ...
        groups = [item['name'] for item in admin_client.list_groups()]
        role_name = [item['name'] for item in admin_client.list_groups()]
        #role_name = admin_client.get_own_user().get_settings().get_raw().get('groups')
        ...
        project_utils.remove_dataset_ref(admin_client, project_key)
